...
- observations: add immutable structured product observations for search, generic tool/activity, source identity, citation-to-source relationships, and required-action evidence; `ProductRuntimeExecution` now carries runtime-owned observations and a dropped-observation-event count
