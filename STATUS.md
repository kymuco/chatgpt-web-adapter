...
→ PR15.20 consolidate PR8.11 early response completion [merged]
...
→ PR15.35 consolidate protected-submit expression ownership [merged]
...
→ PR15.53 minimal DeepSeek Web text new-chat/continuation proof [active]
```
