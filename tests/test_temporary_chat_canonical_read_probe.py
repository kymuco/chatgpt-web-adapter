...
def test_temporary_canonical_read_requires_live_source_confirmation() -> None:
    with pytest.raises(ValueError, match="source_temporary_tab_confirmed_open"):
        probe_temporary_canonical_read(
            "ephemeral-1",
            source_temporary_tab_confirmed_open=False,
