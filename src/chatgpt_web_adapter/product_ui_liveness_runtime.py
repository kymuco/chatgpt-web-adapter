...
def observe_product_ui_liveness(
...
def augment_product_ui_liveness_governance(
    runtime: ChatGPTProductRuntime,
    governance: dict[str, Any],
) -> dict[str, Any]:
    payload = dict(governance)
    provider = getattr(runtime.write_transport, "provider", None)
    supported = bool(
        runtime.transport == BROWSER_OWNED_PRODUCT_TRANSPORT
