// PR14.3 browser-composer indentation correlation compatibility.
//
// Live Codexia cognition evidence proved an ordinary request whose observed and
// expected texts had identical length, one exact user message identity, and a
// first mismatch exactly at the first two-space JSON indentation emitted by
// Python's pretty printer. Contenteditable composers may preserve line-leading
// ASCII indentation with non-breaking Unicode space code points before ChatGPT
...
// already-reviewed PR14.2/schema-29 inspector runs.

const CWA_BROWSER_INDENT_COMPAT_SCHEMA = 1;
const CWA_BROWSER_INDENT_DIAGNOSTIC_KEY =
  "cwa_pr14_3_browser_indent_correlation_fingerprint";
